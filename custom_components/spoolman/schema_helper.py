        ...
        return vol.Schema(
            {
                ...
                vol.Required(
                    ...
                    default=get_default_value(
                        CONF_NOTIFICATION_THRESHOLD_INFO,
                        NOTIFICATION_THRESHOLDS.get("info", 0),
                    ),
                ...
                vol.Required(
                    ...
                    default=get_default_value(
                        CONF_NOTIFICATION_THRESHOLD_WARNING,
                        NOTIFICATION_THRESHOLDS.get("warning", 0),
                    ),
                ): vol.All(int, vol.Range(min=0, max=100)),
                vol.Required(
                    CONF_NOTIFICATION_THRESHOLD_CRITICAL,
                    default=get_default_value(
                        CONF_NOTIFICATION_THRESHOLD_CRITICAL,
                        NOTIFICATION_THRESHOLDS.get("critical", 0),
                    ),
                ): vol.All(int, vol.Range(min=0, max=100)),
                vol.Required(
                    CONF_SHOW_ARCHIVED,
                    default=get_default_value(CONF_SHOW_ARCHIVED, False),
                ): bool,
                vol.Optional(
                    KLIPPER_URL,
                    msg=KLIPPER_URL_DESC,
                    default=get_default_value(KLIPPER_URL, ""),
                ): str,
                vol.Optional(
                    CONF_UPDATE_INTERVAL,
                    default=get_default_value(CONF_UPDATE_INTERVAL, 15),

...
class FilamentDiameter(CoordinatorEntity, SensorEntity):
    """Sensor for filament diameter."""
    ...
    def __init__(self, hass, coordinator, spool_data, config_entry) -> None:
        ...
        self.entity_id = generate_entity_id("sensor.{}", f"spoolman_spool_{spool_data['id']}_diameter", hass=hass)
        self._attr_unique_id = f"spoolman_{self._entry.entry_id}_spool_{spool_data['id']}_diameter"
        self._attr_has_entity_name = False
        self._attr_name = f"{spool_name} Diameter"
        self._attr_state_class = SensorStateClass.MEASUREMENT
        self._attr_native_unit_of_measurement = "mm"
        self._attr_icon = "mdi:diameter-outline"
